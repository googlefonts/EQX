...
class UploadTab extends React.Component {
  ...
  matchStyles = () => {
    ...
    codeData.styleHTML += "</style>";
    if(typeof document.getElementById('code-visual') !== "undefined" && document.getElementById('code-visual') && document.getElementById('code-visual').contentWindow.document.getElementById('ext-eqx-styles')){
